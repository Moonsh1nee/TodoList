...
import {fetchLists} from "../redux/slices/lists";
...
export const Header = () => {
    ...
    const userIsLoading = user.status === "loading";
                ...
                <div className="header__left">
                    ...
                    <Link to="/" className="header__logo">
                        <svg className='icon icon--logo' xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
                            <path
                                d="m439-240 221-221-54-54-167 167-81-82-55 54 136 136ZM263.72-96Q234-96 213-117.15T192-168v-624q0-29.7 21.15-50.85Q234.3-864 264-864h312l192 192v504q0 29.7-21.16 50.85Q725.68-96 695.96-96H263.72ZM528-624v-168H264v624h432v-456H528ZM264-792v189-189 624-624Z"/>
                        </svg>
                    ...
                    {isAuth ? (
                        <>
                            <div className="header__account-wrapper">
                                <img src="https://i.pinimg.com/736x/bd/d9/aa/bdd9aaee8c129b1d0a7180512c6f7ae5.jpg"
                                     alt="account logo" className="header__account-img"/>
                                {userIsLoading ? '' :
                                    <span className="header__account-name">{user.data.nickName}</span>}
                            </div>
